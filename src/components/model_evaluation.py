...
load_dotenv()
os.environ['MLFLOW_TRACKING_URI'] = 'https://dagshub.com/rahulsamantcoc2/NASA-Battery-Life-Prediction.mlflow'
    ...
    def log_into_mlflow(self):
        ...
        with mlflow.start_run():
            ...
            if tracking_url_type_store != "file":
                mlflow.sklearn.log_model(model, "model", registered_model_name="LRU-NASA-Battery-Life-Prediction")
            else:
